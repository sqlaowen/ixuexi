...
public class Util {
    ...
    public static Map<String, Object> Class2Map(Object bean) throws IntrospectionException, IllegalAccessException, IllegalArgumentException, InvocationTargetException {
