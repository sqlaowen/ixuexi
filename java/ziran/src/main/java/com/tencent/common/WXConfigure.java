...
//这个就是自己要保管好的私有Key了（切记只能放在自己的后台代码里，不能放在任何可能被看到源代码的客户端程序中）
	...
	private static String key ="CxukqT0OWlXXXrdKFkwfIKXnlFZ11qzC";// "JaokVWiOCCZeibGQrIjZcPXFQFgPw1Nq";

	//微信分配的公众号ID（开通公众号之后可以获取到）
	private static String appID ="wxe21ad38684c7166d";// "wx23e3416eb0c142e9";

	//微信支付分配的商户号ID（开通公众号的微信支付功能之后可以获取到）
	private static String mchID ="1322370501";// "1267007801";
	
	//HTTPS证书的本地路径
	private static String certLocalPath = "C:/Apps/apiclient_cert.p12";
	
	//HTTPS证书密码，默认密码等于商户号MCHID
	private static String certPassword ="1322370501";// "1267007801";
