...
public class PaymentServiceImpl implements PaymentService {
	...
	public PaymentResDto findByPaymentIdOrderId(String orderId, String paymentId) throws ServiceException {
		if ((null == orderId || "".equals(orderId.trim())) && (null == paymentId || "".equals(paymentId.trim()))) {
	...
	@Override
	public List<PaymentResDto> findByMergePaymentId(String mergePaymentId) throws ServiceException {
		if (StringUtils.isBlank(mergePaymentId)) {
			log.error("请求参数mergePaymentId为空...");
			throw new ServiceException("请求参数mergePaymentId为空...");
		}
		return buildResList(paymentMapper.findByMergePaymentId(mergePaymentId));
	}
	
	@Override
	public String findOrderIdByPaymentId(String paymentId, String merchantId) throws ServiceException{
		...
		return paymentMapper.findOrderIdByPaymentId(paymentId, merchantId);
	}
