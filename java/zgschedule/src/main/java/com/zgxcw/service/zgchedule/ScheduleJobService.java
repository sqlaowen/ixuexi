...
public class ScheduleJobService {
  ...
  public void add(ScheduleJob scheduleJob) {
    ...
    try {
      ...
      // job=this.getClass().getClassLoader().loadClass(scheduleJob.getClassName());
    ...
    JobDetail jobDetail =
        JobBuilder.newJob(job).withIdentity(scheduleJob.getName(), scheduleJob.getGroup()).build();
    ...
    CronTrigger trigger =
        TriggerBuilder.newTrigger().withIdentity(scheduleJob.getName(), scheduleJob.getGroup())
        ...
        for (Trigger trigger : triggers) {
          ...
          if (trigger instanceof SimpleTrigger) {
            ...
            scheduleJob.setCronExpression(
                "重复次数:" + (simple.getRepeatCount() == -1 ? "无限" : simple.getRepeatCount())
          ...
          if (trigger instanceof CronTrigger) {
            ...
            scheduleJob.setDescription(cron.getDescription() == null ? ("触发器:" + trigger.getKey())
                : cron.getDescription());
          }
