 ...
 * 
 * 安全校验码查看时，输入支付密码后，页面呈灰色的现象，怎么办？ 解决方法： 1、检查浏览器配置，不让浏览器做弹框屏蔽设置 2、更换浏览器或电脑，重新登录查询。
 */
...
public class AlipayConfig {
   ...
   public static String partner = "2088211554961671";
  
   // 收款支付宝账号
   public static String seller_email = "zhang9192@vip.qq.com";
   
   // 商户的私钥
   public static String key = "azn0ihswk1elxa7ggt63vj37efjhlzld";
