...
<script type="text/javascript">
	...
	var zNodes =[
		...
		{ id:11, pId:1, name:"自定义回复", url:"${ctx}/wx/reply/index", target:"frmMain"},
		{ id:111, pId:1, name:"关注时回复", url:"${ctx}/wx/reply/index", target:"frmMain"},
		{ id:112, pId:1, name:"默认回复", url:"${ctx}/wx/reply/index", target:"frmMain"},
